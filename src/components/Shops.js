    ...
    <div>
      ...
      <div className='shops-top'>
        ...
        <div className="image-container">
          <button onClick={handlePrevImage} className="arrow-left">{'<'}</button>
          <img className="main-image" src={selectedImage} alt="Product" />
          <button onClick={handleNextImage} className="arrow-right">{'>'}</button>
      ...
      <div className="tabs-container">
        ...
        <button className="tab">Reviews & Questions</button>
      </div>
