...
import football1 from '../components/assets/images/martial2.jpg'
import football2 from '../components/assets/images/martial-arts.jpg'
import football from '../components/assets/images/martial-arts.jpg'
                    ...
                    <div className="activity-detailss" onClick={handleClick}>
                        ...
                        <div className='info-with-img'>
                            ...
                            <div className='descp'>
                                ...
                                <div>
                                    <p>
                                        Equip your child with self-defense skills while boosting their confidence and discipline. Our martial arts program is designed for all skill levels, focusing on safety and fun...</p>
                                    <div>
